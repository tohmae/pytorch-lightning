...
class PyTorchProfiler(BaseProfiler):
    ...
    RECORD_FUNCTIONS = {"training_step", "backward", "validation_step", "test_step", "predict_step", "optimizer_step"}
    ...
    def start(self, action_name: str) -> None:
        ...
        if (
            ...
            and any(action_name.endswith(func) for func in self._record_functions)
